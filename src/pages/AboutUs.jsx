...
function AboutUs() {
  ...
  return (
    <div className="px-2 pb-4 flex justify-center">
      <div className='lg:max-w-3xl lg:border-x-2 lg:border-primary lg:px-6'>
        ...
        <div className="flex pt-2">
          <img
            className="w-40 rounded-full mx-auto object-cover lg:w-48 lg:px-2"
            src={member.imageUrl}
            alt={`${member.name}`}
          />
          <div className="px-2 text-sm text-justify lg:py-3">
